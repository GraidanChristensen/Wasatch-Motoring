    ...
    return (
        <div className="Products" id="Products">
            <div className="productChild">
                <Fade bottom>
                <a rel="noreferrer" target="_blank" href="https://www.xpel.com/products/paint-protection-film"><img alt="clear coat" className="coatImage" src="https://www.autopaintguard.com/wp-content/uploads/2018/06/XPEL-LOGO.png"/></a>
            ...
            <div className="tintContainer">
                ...
                <div className="tintInfo">
                    <a rel="noreferrer" target="_blank" href="https://www.xpel.com/products/window-film/automotive-window-tint"><img className="tintLogo" alt="xpel tint" src="https://www.ruddicksdetail.com/wp-content/uploads/xpel_prime_window_tint_film.png"/></a>
